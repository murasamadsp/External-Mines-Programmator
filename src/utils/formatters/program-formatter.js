...
export function getActionShortCode(actionCode) {
  ...
  const shortCodes = {
    ...
    // Inventory
    [ProgAction.InventoryUp]: "↑📦",
    [ProgAction.InventoryLeft]: "←📦",
    [ProgAction.InventoryDown]: "↓📦",
    [ProgAction.InventoryRight]: "→📦",
    [ProgAction.BoxAll]: "📦",
    [ProgAction.BoxHalf]: "📦½",
    [ProgAction.BoxWhite]: "⚪",
    [ProgAction.BoxGreen]: "🟢",
    ...
    [ProgAction.YesNoTerminate]: "❌⏹️",
    [ProgAction.NoYesTerminate]: "✅⏹️",
    [ProgAction.Flip]: "🔄",

    // Settings
    [ProgAction.EnableAutoDig]: "⚡ON",
    [ProgAction.DisableAutoDig]: "⚡OFF",
    [ProgAction.EnableAggression]: "😡ON",
    [ProgAction.DisableAggression]: "😌OFF",
    [ProgAction.EnableHand]: "🤏ON",
    [ProgAction.DisableHand]: "✋OFF",
