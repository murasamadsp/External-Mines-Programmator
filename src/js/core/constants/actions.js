/**
 * @fileoverview Unified Actions Definition (Facade)
...
import { ACTION_METADATA, ACTION_CATEGORIES as Categories } from "../data/action-metadata.js";
...
// Re-export Utils
export const getActionCode = ActionUtils.getActionCode;
export const getActionByCode = ActionUtils.getActionByCode;
export const getActionMetadata = ActionUtils.getActionMetadata;
export const getActionName = ActionUtils.getActionName;
...
export const isValidActionCode = (code) => ActionUtils.getActionName(code) !== null;
...
export const isUnknownOrUnused = (name) => name.startsWith("UNKNOWN_") || name.startsWith("UNUSED_");
