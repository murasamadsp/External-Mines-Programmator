...
@Component({
  ...
  template: `
    <div class="demo-component-container">
      <h2>DemoComponent Component</h2>
      <p>This is a DemoComponent component with OnPush change detection.</p>
