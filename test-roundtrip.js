...
async function testRoundTrip() {
  console.log("🧪 Testing round-trip serialization with provided base64...");
  ...
  try {
    ...
    if (isIdentical) {
      console.log("✅ ROUND-TRIP TEST PASSED: Input and output are identical!");
      console.log(`   Input length:  ${testBase64.length} characters`);
      console.log(`   Output length: ${exportedBase64.length} characters`);
      console.log("🎉 Perfect 1:1 round-trip serialization achieved!");
    } else {
